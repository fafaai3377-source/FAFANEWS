...
AI = [
 ...
 ("EU 이사회, AI법 간소화 패키지 최종 승인",
  ...
  "Digital Watch Observatory", "https://dig.watch/updates/eu-approves-new-rules-to-simplify-ai-regulation"),
 ...
 ("SK하이닉스, AI 메모리 호황 업고 나스닥 상장 신청",
  ...
  "Yahoo Finance", "https://finance.yahoo.com/markets/stocks/articles/sk-hynix-files-nasdaq-debut-122109516.html"),
