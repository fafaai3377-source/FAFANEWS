...
AI = [
 ...
 ("앤스로픽(Anthropic)·블랙스톤, 기업 AI 서비스 '오드' 출범",
  ...
  "Blockonomi", "https://blockonomi.com/anthropic-bets-big-on-ai-implementation-with-1-5b-ode-launch/"),
...
DESIGN = [
 ...
 ("오젠, 마더디자인(Mother Design)과 오럴케어 브랜드 아이덴티티 공개",
  ...
  "Brand New", "https://www.underconsideration.com/brandnew/archives/new_logo_and_packaging_for_ozen_by_mother_design.php"),
