...
description: 지난 24시간 AI·디자인·마케팅 아티클을 웹 검색으로 수집해 한국어로 번역·요약하고, Pretendard 기반의 1080×1350 카드 22장(표지 1 + AI 7 + 디자인 7 + 마케팅 7)을 만든 뒤, 카드당 실제 기사 이미지와 클릭 가능한 출처 링크를 포함한 PDF(YYMMDD_FAFA NEWS.pdf)로 출력한다. "디자인 마케팅 브리핑", "FAFA NEWS", "오늘의 디자인 소식 카드" 요청 시 사용.
---
